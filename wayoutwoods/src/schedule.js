      ...
      <Accordion flush open={open} toggle={toggle}>
        <AccordionItem>
          ...
          <AccordionBody accordionId="1">
            <strong>
              Those of you coming for the whole weekend - Welcome to the woods!
            </strong>
            <br></br>
            ...
            <br></br>
            Food and drinks provided - also some options for the dairy and
            gluten intolerant
            <br></br>
            <br></br>
        ...
        <AccordionItem>
          ...
          <AccordionBody accordionId="2">
            ...
            <i>
              We'll offer coffee and sandwich material, bring if you want more.
              Optional to eat there or airbnbs
            </i>
            <br></br>
            <br></br>
            ...
            <li>Visit the little shops around</li>
            <li>Visit the market in Simlångsdalen (15 min away)</li>
            <li>Try your fishing luck</li>
            <li>Kid's music and play</li>
            <li>Hang out</li>
            <li>Rest</li>
            <br></br>
            <br></br>
            <strong>Korv me brö / hot dog lunch - Vrågården</strong>
            <i>Simple, bring more to eat if you want or need</i>
            ...
            <i>Bring protein and sides, some salads will be made</i>
            <br></br>
            <br></br>
        ...
        <AccordionItem>
          <AccordionHeader targetId="4">Lineup</AccordionHeader>
